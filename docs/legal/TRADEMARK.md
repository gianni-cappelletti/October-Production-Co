...
trademarks, or service marks." This is standard practice for open source projects
(see: Mozilla/Firefox, Red Hat, WordPress, Godot).
...
- Using the Marks as the name or branding of a fork, derivative, or modified build.
- Modifying, distorting, or altering the logo.
- Implying endorsement, sponsorship, or affiliation with October Production Co.
...
The logo asset (`OctoberLogo.png`) is included in this repository under a separate
proprietary license (`LICENSES/LicenseRef-OPC-Trademark.txt`) and may not be
extracted, modified, or redistributed independently.

## Contact

For trademark questions or permission requests: gianni@octoberproductionco.com
